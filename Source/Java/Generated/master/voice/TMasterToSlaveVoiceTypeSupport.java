 ...
 * TMasterToSlaveVoice.
 */
public class TMasterToSlaveVoiceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "master::voice::TMasterToSlaveVoice";
    ...
    private static final TMasterToSlaveVoiceTypeSupport _singleton
        = new TMasterToSlaveVoiceTypeSupport();
     ...
     */
    public static TMasterToSlaveVoiceTypeSupport get_instance() {
        return _singleton;
    }

    public static TMasterToSlaveVoiceTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return TMasterToSlaveVoice.create();
    }
    ...
    public Object create_key() {
        return new TMasterToSlaveVoice();
    }
    ...
    public Class get_type() {
        return TMasterToSlaveVoice.class;
    }
     ...
     * <code>this</code> is not a <code>TMasterToSlaveVoice</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        TMasterToSlaveVoice typedDst = (TMasterToSlaveVoice) destination;
        TMasterToSlaveVoice typedSrc = (TMasterToSlaveVoice) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        TMasterToSlaveVoice typedSrc = (TMasterToSlaveVoice) sample;
        ...
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.voiceCommand);
...
TMasterToSlaveVoice typedSrc = (TMasterToSlaveVoice) src;    
        ...
        dst.writeString(typedSrc.voiceCommand,(255));
...
TMasterToSlaveVoice typedDst = (TMasterToSlaveVoice) dst;
        
            typedDst.clear();
    try {

            typedDst.voiceCommand = src.readString((255));
...
TMasterToSlaveVoice typedDst = (TMasterToSlaveVoice) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
TMasterToSlaveVoice typedDst = (TMasterToSlaveVoice) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new TMasterToSlaveVoiceDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new TMasterToSlaveVoiceDataReader(native_reader, listener, mask, this);                
    ...
    protected TMasterToSlaveVoiceTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TMasterToSlaveVoiceTypeCode.VALUE,TMasterToSlaveVoice.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected TMasterToSlaveVoiceTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,TMasterToSlaveVoiceTypeCode.VALUE,TMasterToSlaveVoice.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
