 ...
 * TMasterToHands.
 */
public class TMasterToHandsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "master::hands::TMasterToHands";
    ...
    private static final TMasterToHandsTypeSupport _singleton
        = new TMasterToHandsTypeSupport();
     ...
     */
    public static TMasterToHandsTypeSupport get_instance() {
        return _singleton;
    }

    public static TMasterToHandsTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return TMasterToHands.create();
    }
     ...
     * <code>this</code> is not a <code>TMasterToHands</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        TMasterToHands typedDst = (TMasterToHands) destination;
        TMasterToHands typedSrc = (TMasterToHands) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        TMasterToHands typedSrc = (TMasterToHands) sample;
...
TMasterToHands typedDst = (TMasterToHands) dst;
...
TMasterToHands typedDst = (TMasterToHands) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
TMasterToHands typedDst = (TMasterToHands) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new TMasterToHandsDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new TMasterToHandsDataReader(native_reader, listener, mask, this);                
    ...
    protected TMasterToHandsTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TMasterToHandsTypeCode.VALUE,TMasterToHands.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected TMasterToHandsTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,TMasterToHandsTypeCode.VALUE,TMasterToHands.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
