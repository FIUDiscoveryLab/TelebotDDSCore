...
/**
 * A sequence of TMasterToHands instances.
 */
public final class TMasterToHandsSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public TMasterToHandsSeq() {
        super(TMasterToHands.class);
    }


    public TMasterToHandsSeq(int initialMaximum) {
        super(TMasterToHands.class, initialMaximum);
    }


    public TMasterToHandsSeq(Collection elements) {
        super(TMasterToHands.class, elements);
    }
