...
/**
 * A sequence of TMasterToArms instances.
 */
public final class TMasterToArmsSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public TMasterToArmsSeq() {
        super(TMasterToArms.class);
    }


    public TMasterToArmsSeq(int initialMaximum) {
        super(TMasterToArms.class, initialMaximum);
    }


    public TMasterToArmsSeq(Collection elements) {
        super(TMasterToArms.class, elements);
    }
