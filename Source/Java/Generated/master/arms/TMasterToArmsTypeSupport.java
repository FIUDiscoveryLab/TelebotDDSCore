 ...
 * TMasterToArms.
 */
public class TMasterToArmsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "master::arms::TMasterToArms";
    ...
    private static final TMasterToArmsTypeSupport _singleton
        = new TMasterToArmsTypeSupport();
     ...
     */
    public static TMasterToArmsTypeSupport get_instance() {
        return _singleton;
    }

    public static TMasterToArmsTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return TMasterToArms.create();
    }
     ...
     * <code>this</code> is not a <code>TMasterToArms</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        TMasterToArms typedDst = (TMasterToArms) destination;
        TMasterToArms typedSrc = (TMasterToArms) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        TMasterToArms typedSrc = (TMasterToArms) sample;
...
TMasterToArms typedSrc = (TMasterToArms) src;    
        ...
        dst.writeInt(typedSrc.servoId);        
            
        dst.writeInt(typedSrc.servoPositon);        
            
        dst.writeInt(typedSrc.servoSpeed);        
...
TMasterToArms typedDst = (TMasterToArms) dst;
        
            typedDst.clear();
    try {

            typedDst.servoId = src.readInt();
            
            typedDst.servoPositon = src.readInt();
            
            typedDst.servoSpeed = src.readInt();
...
TMasterToArms typedDst = (TMasterToArms) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
TMasterToArms typedDst = (TMasterToArms) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new TMasterToArmsDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new TMasterToArmsDataReader(native_reader, listener, mask, this);                
    ...
    protected TMasterToArmsTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TMasterToArmsTypeCode.VALUE,TMasterToArms.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected TMasterToArmsTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,TMasterToArmsTypeCode.VALUE,TMasterToArms.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
